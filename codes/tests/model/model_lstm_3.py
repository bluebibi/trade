...
data = ARData(
    num_datapoints,
    num_prev=input_size, test_size=test_size, noise_var=noise_var,
...
print("X_train: {0}".format(X_train.size()))
print("y_train: {0}".format(y_train.size()))
print("X_test: {0}".format(X_test.size()))
print("y_test: {0}".format(y_test.size()))
