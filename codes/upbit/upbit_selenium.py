...
if platform.system() == "Darwin":
    ...
    driver = webdriver.Chrome(os.path.join(PROJECT_HOME, "codes", "upbit", "chromedriver_mac"), options=options)
    ...
    driver = webdriver.Firefox(executable_path=os.path.join(PROJECT_HOME, "codes", "upbit", "geckodriver"), options=options)
    driver.implicitly_wait(3)
    driver.get('https://upbit.com')
